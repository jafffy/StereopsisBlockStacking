...
{
    class StereopsisBlockStackingMain : public DX::IDeviceNotify
    {
    public:
        StereopsisBlockStackingMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~StereopsisBlockStackingMain();
