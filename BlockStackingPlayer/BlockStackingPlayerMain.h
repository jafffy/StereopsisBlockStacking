...
namespace BlockStackingPlayer
{
    class BlockStackingPlayerMain : public DX::IDeviceNotify
    {
    public:
        BlockStackingPlayerMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~BlockStackingPlayerMain();
